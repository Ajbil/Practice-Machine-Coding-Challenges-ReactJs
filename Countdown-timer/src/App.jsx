...
function App(){
  ...
  const {secondsLeft} = useTimer(
    hoursEntered, minutesEntered, secondsEntered, started, setStarted
  );
      ...
      (
        <div className="div2">
          <div>
            ...
            value={hoursEntered}
            type="Number"
            onChange={(e) => handleUserInput(e, "hours")}></input>
          </div>
          ...
          <div>
            ...
            type="Number"
            onChange={(e) => handleUserInput(e, "minutes")}></input>
          </div>
          ...
          <div>
            ...
            type="Number"
            onChange={(e) => handleUserInput(e, "seconds")}></input>
          </div>
